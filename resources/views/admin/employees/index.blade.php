...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center me-3">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">@lang('Employees')
            <!--begin::Separator-->
...
<div class="card rounded mb-5 mb-xl-8 shadow-lg">
    ...
    <div class="card-header rounded border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">@lang('Employees')</span>
        </h3>
            ...
            <table class="table table-hover align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-125px">@lang('position')</th>
                        <th class="min-w-125px">@lang('balance')</th>
...
{{-- @dd($users); --}}
                @foreach($data as $key => $c)
                    <tr class="text-center border-3 m-auto">
                         ...
                         <td class="px-3">
                                    <span class="badge badge-light-primary fs-7 fw-bold">{{$c->position}}</span>
                        </td>
